document.addEventListener("DOMContentLoaded", function() {
    const downloadButton = document.getElementById('download-pdf3');
    ...
    if (downloadButton) {
        downloadButton.addEventListener('click', function() {
            ...
            const title = "Relatório de Materiais Cadastradas";
            const subtitle = "Informações detalhadas sobre as materiais do sistema.";
